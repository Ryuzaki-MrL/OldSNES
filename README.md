...
- Enjoy.
Note: If you don't provide an icon.png file, banner.png will be used for the icon instead.

CUSTOM BANNER (OPTIONAL):
- Put a screenshot of the game on the folder you created for the game, and rename it banner.png.
- OPTIONAL: Put a box art or cartridge label image of the game on the input folder, and rename it label.png or label.jpg.
- Run banner.bat.
...
- Go to config folder and select a config template.
  - Mode7: activate experimental MODE 7 filtering.
